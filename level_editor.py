...
PALETTE: List[Tuple[str, str, Tuple[int, int, int]]] = [
    ...
    ("Q", "Coin-Block", (245, 200, 70)),
    ("S", "Zerbrechlich", (200, 140, 90)),
    ("H", "Kopfzerbrecher", (205, 150, 100)),
    ("M", "Pilz", (220, 80, 80)),
    ("G", "Goomba", (190, 110, 70)),
    ("|", "Gate", (110, 210, 255)),
...
def draw_tile(surface: pygame.Surface, char: str, rect: pygame.Rect) -> None:
    ...
    if char == "B":
        pygame.draw.rect(surface, (240, 190, 80), rect, border_radius=6)
        top = rect.copy()
        top.height = max(4, rect.height // 4)
        pygame.draw.rect(surface, (255, 225, 140), top, border_radius=6)
        mark = pygame.Rect(rect.centerx - 6, rect.y + rect.height // 3 - 6, 12, 12)
    ...
    if char == "Q":
        pygame.draw.rect(surface, (245, 200, 70), rect, border_radius=6)
        top = rect.copy()
        top.height = max(4, rect.height // 4)
        pygame.draw.rect(surface, (255, 235, 150), top, border_radius=6)
        coin = pygame.Rect(0, 0, max(10, rect.width // 2), max(10, rect.height // 2))
        coin.center = rect.center
        pygame.draw.ellipse(surface, (255, 225, 90), coin)
        pygame.draw.ellipse(surface, (255, 240, 160), coin, 3)
        return
    ...
    if char == "H":
        pygame.draw.rect(surface, (205, 150, 100), rect, border_radius=6)
        top = rect.copy()
        top.height = max(4, rect.height // 4)
        pygame.draw.rect(surface, (245, 205, 155), top, border_radius=6)
        notch = pygame.Rect(rect.centerx - 6, rect.centery - 6, 12, 12)
        pygame.draw.rect(surface, (150, 110, 70), notch, border_radius=3)
        return
